...
{/* 
            ...
            {!isRegistering && (
              <button
                ...
                className="w-full flex justify-center items-center gap-2 py-3 px-4 mt-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors"
              >
